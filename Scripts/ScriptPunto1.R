...
ggplot(geih_limpia2, aes(age,ingtot, color=sex)) + geom_point() + geom_smooth(colour="#CC0000") + 
  labs(title = "Gráfico de disperción",subtitle = "Edad vs Ingreso total", y="Ingreso total", x="Edad")

ggplot(geih_limpia2, aes(totalHoursWorked,ingtot, color=sex)) + geom_point() + geom_smooth(colour="#CC0000") +
  labs(title = "Gráfico de disperción",subtitle = "Horas trabajadas vs Ingreso total", y="Ingreso total",x="Total horas trabajadas")

ggplot(geih_limpia2,aes(ingtot),stat_bin(1)) + geom_histogram()
ggplot(data = geih_limpia2,aes(ingtot)) +geom_histogram(bins = 20) +
  labs(title = "Histograma",subtitle = "Ingreso total",x="Ingreso total",y="Count")
ggplot(geih_limpia2,aes(maxEducLevel, ingtot, color=sex)) + geom_point() +
  labs(title = "Gráfico de dispersión",subtitle = "Nivel de educación vs Ingreso total", y="Ingreso total", x="Nivel de educación")
